...
class GastosControllerTest < ActionController::TestCase
  ...
  test "should create gasto" do
    assert_difference('Gasto.count') do
      post :create, gasto: { categoria: @gasto.categoria, data: @gasto.data, descricao: @gasto.descricao, valor: @gasto.valor }
    end
  ...
  test "should update gasto" do
    put :update, id: @gasto, gasto: { categoria: @gasto.categoria, data: @gasto.data, descricao: @gasto.descricao, valor: @gasto.valor }
    assert_redirected_to gasto_path(assigns(:gasto))
  end
